...
static const u32 MEM_OFFSET = 0x80000000;
...
static void B_type(u32* pc, const u8 func3, const u32 regs[32], const u8 rs1, 
...
static void L_type(const u8* mem, const u8 func3, u32 regs[32], const u8 rd, 
...
static void S_type(u8* mem, const u8 func3, const u32 regs[32], const u8 rs1, 
	const u8 rs2, const i16 imm){
...
static void I_type(const u8 func3, const u8 func7, u32 regs[32], const u8 rd, 
...
static void R_type(const u8 func3, const u8 func7, u32 regs[32], const u8 rd, 
...
void tinyriscv_step(tinyriscv_Cpu* cpu){
	//fetch
